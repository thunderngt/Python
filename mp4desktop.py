...
def on_button_click():
  ...
  # Baixar o vídeo
  video.download("C:/Users/Cliente/Desktop")

  # Renomear o arquivo baixado para que ele tenha a extensão .mp4
  os.rename("C:/Users/Cliente/Desktop/{}".format(video.default_filename),
            "C:/Users/Cliente/Desktop/{}.mp4".format(os.path.splitext(video.default_filename)[0]))
